                        ...
                        EditorApplication.delayCall += () =>
                        {
                            ...
                            while (boneTarget.transform.childCount > 0)
                            {
                                ...
                                if (bone != null && boneTarget.bonePositionSave)
                                {
                                    ...
                                    bone.bonePosition += boneTarget.bonePosition;
                                }
                            }
                    ...
                    #region Handle
                    {
                        Vector3 pos = (objectTarget.bindposes[boneTarget.boneIndex] * objectTarget.transform.worldToLocalMatrix).inverse.GetColumn(3);
                        {
                            ...
                            if (EditorGUI.EndChangeCheck())
                            {
                                ...
                                {
                                    var tmp = new IntVector3(Mathf.FloorToInt(boneTarget.transform.localPosition.x / (0.5f * objectTarget.importScale.x)), Mathf.FloorToInt(boneTarget.transform.localPosition.y / (0.5f * objectTarget.importScale.y)), Mathf.FloorToInt(boneTarget.transform.localPosition.z / (0.5f * objectTarget.importScale.z)));
